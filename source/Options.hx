...
class ResetAchievements extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.noHunger = null;
		FlxG.save.data.fcFDY = null;
		FlxG.save.data.die69Times = null;
		FlxG.save.data.dissus = null;
		FlxG.save.data.dyingIsGay = null;
		FlxG.save.data.susCode = null;
		FlxG.save.data.staticCode = null;
		FlxG.save.data.secretAcheivement = null;
		FlxG.save.data.bigShotCode = null;
		FlxG.save.data.starValleyCode = null;
		confirm = false;
		trace('All Achievements have been reset');
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return confirm ? "Confirm Achievements Reset" : "Reset Achievements";
	}
}
