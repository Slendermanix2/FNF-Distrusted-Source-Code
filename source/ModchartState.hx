	...
	function makeLuaSprite(spritePath:String,toBeCalled:String, drawBehind:Bool)
	{
        ...
        @:privateAccess
        {
            if (drawBehind)
            {
                ...
                PlayState.instance.removeObject(PlayState.boyfriend);
                PlayState.instance.removeObject(PlayState.dad);
				PlayState.instance.removeObject(PlayState.sans);
                PlayState.instance.removeObject(PlayState.alphys);
                PlayState.instance.removeObject(PlayState.dadTwo);
				PlayState.instance.removeObject(PlayState.papyrus);
            }
            PlayState.instance.addObject(sprite);
            if (drawBehind)
            {
                ...
                PlayState.instance.addObject(PlayState.boyfriend);
                PlayState.instance.addObject(PlayState.dad);
				PlayState.instance.addObject(PlayState.sans);
                PlayState.instance.addObject(PlayState.alphys);
                PlayState.instance.addObject(PlayState.dadTwo);
				PlayState.instance.addObject(PlayState.papyrus);
            }
        }
		#end
		return toBeCalled;
